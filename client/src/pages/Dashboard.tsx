...
import { ArrowUp, ArrowDown, LayoutGrid, Table as TableIcon } from "lucide-react";
            ...
            >
              <AreaChart data={data}>
                <defs>
                  ...
                  <linearGradient id="colorPrevPrice" x1="0" y1="0" x2="0" y2="1">
                ...
                <Area type="monotone" dataKey="previousPrice" stroke="#4ade80" fillOpacity={1} fill="url(#colorPrevPrice)" />
...
const StatsCard = ({ title, value, change, trend, subtitle, description }: StatsCardProps) => {
  return (
    <Card>
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm font-medium text-muted-foreground">{title}</CardTitle>
          <div className={`px-2 py-1 rounded-md text-xs flex items-center ${trend === "up" ? "bg-green-500/20 text-green-700" : "bg-red-500/20 text-red-700"}`}>
