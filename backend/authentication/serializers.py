...
class LoginSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        if username and password:
            ...
            if not user:
                ...
                try:
                    ...
                    if not user_by_username.is_active:
                        ...
                        raise serializers.ValidationError(
                            f"Looks like you have not confirmed your email: [{user_by_username.email}]. Please check your inbox (spam as well).",
                            code="authentication",
                        )
            ...
            raise serializers.ValidationError(
                'Must include "username" and "password".', code="authentication"
            )
...
class RequestPasswordResetSerializer(serializers.Serializer):
    ...
    def save(self):
        ...
        send_mail(
            subject, message.replace("&amp;", "&"), settings.DEFAULT_FROM_EMAIL, [email]
        )
...
class UserDetailsSerializer(serializers.ModelSerializer):
    credits = serializers.FloatField(
        source="creditwallet.total_credits", read_only=True
    )
    ...
    class Meta:
        ...
        fields = (
            ...
            "is_2fa_enabled",
            "credits",
        )  # Include is_active and is_2fa_enabled
